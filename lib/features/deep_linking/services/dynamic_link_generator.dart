...
class DynamicLinkGenerator {
  // Configuration - Uses app-wide constants
  static const String dynamicLinkDomain = AppConstants.deepLinkDomain;
  static const String androidPackage = AppConstants.androidPackage;
  static const String webBaseUrl = AppConstants.webBaseUrl;
